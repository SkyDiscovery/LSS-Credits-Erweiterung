...
var credits_gesamt = 0;
var naechster_grad = "undefined";
...
function gesamtcredits_aktualisieren(){
    profil = window.open(document.getElementById("navbar_profile_link").href, "profil", "width=1,height=1,status=yes,scrollbars=yes,resizable=yes");
    window.setTimeout(1000);
    profil.close();
}

function aktualisieren(){
    gesamtcredits_aktualisieren();
